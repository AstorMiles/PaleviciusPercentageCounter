package one.more.paleviciuspercentagecounter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPercent = findViewById(R.id.percentTextView);
        sbPercent = findViewById(R.id.percentSeekBar);
        tvTip = findViewById(R.id.tipTextView);
